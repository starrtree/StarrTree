...
document.querySelectorAll('.orb-model').forEach(mv=>{mv.setAttribute('camera-controls','');mv.setAttribute('disable-pan','');mv.setAttribute('auto-rotate','');mv.setAttribute('camera-orbit','0deg 75deg 5.2m');mv.setAttribute('min-camera-orbit','auto 45deg 4.4m');mv.setAttribute('max-camera-orbit','auto 95deg 7.2m');mv.setAttribute('field-of-view','28deg');mv.setAttribute('camera-target','0m 0m 0m');mv.setAttribute('auto-rotate-delay','650');mv.setAttribute('rotation-per-second','18deg');mv.setAttribute('interaction-prompt','none')});
